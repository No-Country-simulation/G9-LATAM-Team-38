...
import { LockKeyhole, UserRound, AlertCircle, Bot, Heart, Sparkles, LogIn, KeyRound } from "lucide-react";
...
const miembrosEquipo: Miembro[] = [
  { nombre: "Sonia Moran", rol: "Data Scientist", linkedin: "https://www.linkedin.com/in/sonia-moran-286717422/", github: "https://github.com/Zonya8" },
  { nombre: "Gabriel Gil", rol: "Backend Developer", linkedin: "https://www.linkedin.com/in/gabriel-gil-337a20250/", github: "https://github.com/gilgabriel422-netizen" },
  { nombre: "Armando Tapia ", rol: "Data Scientist", linkedin: "https://www.linkedin.com/in/atapia9/", github: "https://github.com/atapia9" },
  { nombre: "Ian Osnaya", rol: "Backend Developer", linkedin: "https://www.linkedin.com/in/ian-osnaya-0a7b71375/", github: "https://github.com/IanOsnaya" },
  { nombre: "Jesús García", rol: "Data Scientist", linkedin: "https://www.linkedin.com/in/jesusjgarciam/", github: "https://github.com/Electrocyte96" },
  { nombre: "Marco Arias", rol: "Full Stack Developer", linkedin: "https://www.linkedin.com/in/marco-antonio-arias-mullisaca-b688611ba/", github: "https://github.com/marcomull" },
  { nombre: "Brayan Camargo ", rol: "Project Manager", linkedin: "https://www.linkedin.com/in/brayan-camargo-ram%C3%ADrez/", github: "https://github.com/Brayan-Camargo" },
];
        ...
        <div className="w-full max-w-md flex flex-col items-center lg:items-start">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <div className="group bg-[var(--brand-accent)] p-2 rounded-xl shadow-md flex items-center justify-center text-white dark:text-[#0B2545] transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
              <Bot size={28} className="transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3" />
            </div>
            <div>
          ...
          <div className="w-full bg-[var(--brand-card)] rounded-2xl p-6 shadow-2xl border border-[var(--brand-border)]">
            <div className="flex items-center gap-2 mb-6">
              <KeyRound
                size={16}
                className="text-[var(--brand-accent)] transition-all duration-200 hover:scale-110 hover:rotate-6"
              />
            ...
            <form onSubmit={handleLogin} className="bg-[var(--brand-bg)] border border-[var(--brand-border)] rounded-xl p-5 space-y-4">
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[var(--brand-accent)]">
                    <UserRound size={16} className="transition-transform duration-200 group-focus-within:scale-110" />
                  </div>
                  <input
                   type="text"
                    value={username}
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[var(--brand-accent)]">
                    <LockKeyhole size={16} className="transition-transform duration-200 group-focus-within:scale-110" />
                  </div>
                  <input
                    type="password"
                    value={password}
        ...
        <div className="w-full max-w-lg lg:max-w-xl">
          <div className="mb-6 text-center lg:text-left">
            <h2 className="text-2xl md:text-3xl font-bold flex items-center justify-center lg:justify-start gap-2 mb-2 text-[var(--brand-text)]">
              <Sparkles className="text-[var(--brand-accent)] transition-transform duration-300 hover:scale-110 hover:rotate-6" size={24} />
              Equipo Dinamita
            </h2>
            <p className="text-[var(--brand-muted)] text-sm md:text-base leading-relaxed">
              Plataforma desarrollada con <Heart size={14} className="inline text-red-400 mx-1 mb-0.5 transition-transform duration-200 hover:scale-125" /> para la Hackathon. Conoce a los desarrolladores detrás de este proyecto.
            </p>
          </div>
            ...
            {miembrosEquipo.map((miembro, idx) => (
              ...
              >
                <div>
                  ...
                  <span className="font-bold text-xs md:text-sm truncate text-[var(--brand-text)] group-hover:text-[var(--brand-accent)] transition-colors block" title={miembro.nombre}>
                    {miembro.nombre}
                  </span>
                ...
                <div className="flex items-center gap-2.5 mt-3">
                  {miembro.linkedin && (
                    <a href={miembro.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-7 h-7 rounded-md text-[var(--brand-accent)] hover:text-[var(--brand-text)] hover:bg-[var(--brand-accent)]/10 transition-all duration-200 hover:scale-110 active:scale-95" title="LinkedIn" aria-label={`LinkedIn de ${miembro.nombre}`}>
                  ...
                  {miembro.github && (
                    <a href={miembro.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-7 h-7 rounded-md text-[var(--brand-accent)] hover:text-[var(--brand-text)] hover:bg-[var(--brand-accent)]/10 transition-all duration-200 hover:scale-110 active:scale-95" title="GitHub" aria-label={`GitHub de ${miembro.nombre}`}>
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
