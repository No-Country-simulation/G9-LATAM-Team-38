      ...
      {mostrarModal && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className={`bg-[var(--brand-card)] border border-[var(--brand-border)] rounded-2xl p-5 max-w-sm w-full shadow-2xl relative`}>
            ...
            <h3 className="text-sm font-bold mb-3 flex items-center gap-2 group">
              <PlusCircle size={16} className="text-[var(--brand-accent)] transition-transform duration-200 group-hover:rotate-90" /> Añadir Transacción
            </h3>
